...
def get_and_process_data(data_dir):
    ...
    color = np.array(Image.open(os.path.join(data_dir, 'zy_1r.jpg')).convert('RGB'), dtype=np.float32) / 255.0
    depth = np.array(Image.open(os.path.join(data_dir, 'zy_1d.tiff')))
