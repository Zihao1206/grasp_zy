...
class Grasp:
    ...
    # def to_tensor_grasp(self, depth_img, color_img):（已删除）
    ...
    def grasp_img2real_yolo(self, color_img, depth_img, grasp, slope_angle, topk, vis=False, color=(255, 0, 0),
        ...
        return Pobj2base, Robj2base, angle, t_compesate[2], slope_flag
        # return 
    ...
    def obj_grasp(self, label, vis=False):
        ...
        coordinate, ori, angle, z_compensate, slope_flag = self.grasp_img2real_yolo(
        ...
        if self.hardware:
            ...
            while attempt < max_attempt:
                try:
                    ...
                    print("✓ 抓取成功完成！")
                    print(f"间隔时间1为: {end1 - start} 秒")
                    print(f"间隔时间all为: {end - start} 秒")
                    return True
...
if __name__ == '__main__':
    ...
    grasp.obj_grasp(label='banana',vis=True)
