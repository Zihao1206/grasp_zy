...
def detect_grasps(q_img, ang_img, width_img=None, no_grasps=1, pixel_wise_stride=1):
    """
    ...
    for grasp_point_array in local_max:
        ...
        g = Grasp(
            (grasp_point[0]*pixel_wise_stride + pixel_wise_stride//2,
             grasp_point[1]*pixel_wise_stride + pixel_wise_stride//2),
            grasp_angle
        )
