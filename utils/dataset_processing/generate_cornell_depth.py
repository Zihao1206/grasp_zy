...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/home/wangchuxuan/library/cornelldata', type=str, help='Path to Cornell Grasping Dataset')
    ...
    for pcd in pcds:
        di = DepthImage.from_pcd(pcd, (480, 640), index=2)
        di.inpaint()
